...
with program() as hello_QUA:
    ...
    with while_(n < N):
        ...
        # wait(5000, "AOM")
        wait(25_000, "mirror_x")
        play("const", "mirror_x", duration=250_000) ## voltage out to piezo controller 
        # wait(25_000, "Piezo_x")
...
if simulate:
    ...
    fig, ax = plt.subplots()
    ax.plot(samples.con1.analog["5"], '-', label="Analog 5")
    # ax.plot(samples.con1.analog["6"], '--', label="Analog 6")
