...
# Pulses lengths
slice_size = 5 * u.us // 4 #5 4us
#slice_size = 8 * u.ns // 4 #5 4us

initialization_len_1 = 16 * u.ns
meas_len_1  =200 * u.us #600 5 * u.us #trace /600
#meas_len_1 = 10 * u.us #10 frequency sweep
...
# Piezo control
piezo_controll = 0.1 # in units of volts
piezo_duration = 100 * u.us
...
# Readout parameters
signal_threshold_1 = -6_000 # 0.48  # ADC untis, to convert to volts divide by 4096 (12 bit ADC)
...
config = {
    ...
    "pulses": {
        ...
        "piezo_pulse_single": {
            "operation": "control",
            "length": piezo_duration,  # in ns
            "waveforms": {"single": "piezo_const_wf"},
            # "digital_marker": "MW_ON",
        },
        "laser_ON_1": {
            "operation": "control",
    ...
    "waveforms": {
        ...
        "piezo_const_wf": {"type": "constant", "sample": piezo_controll},
    },
    "digital_waveforms": {
