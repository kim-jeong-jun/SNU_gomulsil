...
# Pulses lengths
# slice_size = 4 * u.ns // 4 #4us
initialization_len_1 = 20 * u.ns
# meas_len_1 = 0.1 * u.us
meas_len_1 = 1000 * u.ns
...
mirror_frequency = 500 * u.Hz 
# mirror_amp = -0.2
mirror_amp = 0.15
mirror_amp_inverse = - 0.2
...
config = {
    ...
    "controllers": {
        "con1": {
            "analog_outputs": {
                1: {"offset": 0.0, "delay": mw_delay},  # RF1
                2: {"offset": 0.0, "delay": mw_delay},  # RF2
                3: {"offset": 0.0, "delay": rf_delay},  # mirror                
                4: {"offset": 0.0, "delay": rf_delay},
                5: {"offset": 0.0, "delay": 0.0}, # SPCM
            },
            "digital_outputs": {
                1: {},  # AOM/Laser
                2: {},  # AOM/Laser
    ...
    "elements": {
        ...
        "mirror_y": {
            ...
            "intermediate_frequency": mirror_frequency,
            "operations": {
                # "const": "const_pulse_single_inverse",
                "const": "const_pulse_single",
            },
        },
        "RF3": {
        ...
        "SPCM1": {
            ...
            "outputs": {"out1": ("con1", 1)}, # analog input 1
    ...
    "pulses": {
        ...
        "const_pulse_single_inverse": {
            "operation": "control",
            "length": 1000,  # in ns
            "waveforms": {"single": "const_wf_inverse"},
            # "digital_marker": "MW_ON",
        },
    ...
    "waveforms": {
        ...
        "const_wf_inverse": {"type": "constant", "sample": mirror_amp_inverse},        
